...
const Form: FC<Props> = ({ backgroundForm, onInputFocus }) => {
    ...
    const massageSuccess = () => toast.success('😃 SUCCESS!', {
        position: "top-center",
        autoClose: 5000,
    ...
    const massageError = () => toast.error('😲 ERROR!', {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    return (
        ...
        <>
            <div className="relative 3xl:h-90 3xl:w-120 2xl:h-110 3xl:mt-10  lg:h-100 lg:w-100 md:w-46 md:h-90 w-98 h-91  rounded-2xl" style={{ backgroundColor: backgroundForm }}>
                <div className="">
                    <div className="absolute p-5 h-screen lg:overflow-hidden md:overflow-hidden sm:overflow-hidden xs:overflow-hidden overflow-auto">
                        <div className="text-white lg:mt-0 md:mt-0 sm:mt-0 -mt-3">
                            <p className="xl:text-2xl 2xl:text-2xl lg:text-2xl md:text-2xl sm:text-xl text-xs">Bize Ulaşın</p>
                            <p className="lg:text-xl md:text-xl sm:text-lg mt-1 text-xs">Merak ettiğiniz tum konular hakkında</p>
                            <p className="lg:text-xl md:text-xl sm:text-lg text-xs">Bilgi alın!</p>
                        </div>
                        {/* form input */}
                        <form onSubmit={handleSubmit(onSubmit)} className="">
                            <div className="3xl:mt-5 lg:mt-4 md:mt-4 sm:mt-4 xs:mt-2 xm:mt-2">
                                <label className="block mb-1 text-white 3xl:text-lg lg:text-xs md:text-xs text-xs " htmlFor="formGridCode_card">AD SOYAD</label>
                                <input name="username" ref={register({ required: true })}
                                    className={` ${errors.username && "border-b-2 border-red-500"} ${errors.username && "placeholder-red-600 placeholder-opacity-60"} text-white 3xl:w-97 2xl:w-97 xl:w-97 lg:w-97 md:w-95 sm:w-97 w-72 text-base border-b-2 border-white  outline-none placeholder-white placeholder-opacity-40`}
                            ...
                            <div className="3xl:mt-5 xs:mt-4 xm:mt-2">
                                <label className="block mb-1 text-white 3xl:text-lg lg:text-xs md:text-xs text-xs " htmlFor="formGridCode_card">EMAİL ADRESİ</label>
                                <input name="email"
                                    ref={register({
                                    ...
                                    className={` ${errors.email && "border-b-2 border-red-500"} ${errors.email && "placeholder-red-600 placeholder-opacity-60"} text-white 3xl:w-97 2xl:w-97 xl:w-97 lg:w-97 md:w-95 sm:w-97 w-72 text-base border-b-2 border-white  outline-none placeholder-white placeholder-opacity-40`}
                            ...
                            <div className="3xl:mt-5  xs:mt-2 xm:mt-2">
                                <label className="block mb-1 text-white 3xl:text-lg lg:text-xs md:text-xs text-xs " htmlFor="formGridCode_card">TELEFON NUMARASI</label>
                                <input name="phoneNumber"
                                    ref={register({
                                        validate: (value) => value.length > 10
                                    })}
                                    className={`${errors.phoneNumber && "border-b-2 border-red-500"} ${errors.phoneNumber && "placeholder-red-600 placeholder-opacity-60"} text-white 3xl:w-97 2xl:w-97 xl:w-97 lg:w-97 md:w-95 sm:w-97 w-72 text-base border-b-2 border-white  outline-none placeholder-white placeholder-opacity-40`}
                            ...
                            <div className="3xl:mt-5 xs:mt-2 xm:mt-2">
                                <label className="block mb-1 text-white 3xl:text-lg lg:text-xs md:text-xs text-xs ">HİZMETLER</label>
                                <select name="service" ref={register({ required: true })}
                                    className={`${errors.service && "border-b-2 border-red-500"} ${errors.service && "placeholder-red-600 placeholder-opacity-60"}  text-white placeholder-white placeholder-opacity-40 3xl:w-97 2xl:w-97 xl:w-97 lg:w-97 md:w-95 sm:w-97 w-72 border-white border-b-2 outline-none text-xs`}
                                    style={{ backgroundColor: backgroundForm }}
                            ...
                            <div className="3xl:mt-5  xs:mt-2 xm:mt-2">
                                ...
                                <textarea
                                        ...
                                        className={`${errors.description && "border-b-2 border-red-500"} ${errors.description && "placeholder-red-600 placeholder-opacity-60"} resize-none shadow form-textarea mt-1 block border-2 border-white rounded 3xl:w-97 2xl:w-97 xl:w-97 lg:w-97 md:w-95 sm:w-97 w-72 py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline placeholder-gray-50 text-sm placeholder-opacity-60`}
                                        placeholder="Mesajınızı Yazınız"
                                        style={{ backgroundColor: backgroundForm }} />
                                </label>
                            </div>
                            <div className="flex justify-end absolute z-10 right-5">
                                <input type="submit" value="Gönder" className={cn(style.btn, "bg-white rounded-full w-32 mt-3 mr-5 text-blue-400 p-1 cursor-pointer")} />
                                <ToastContainer
                                    position="top-center"
                                    autoClose={5000}
                                    hideProgressBar={false}
                    ...
                    {/* cadr */}
                    <div className="lg:block md:block hidden absolute p-3 z-10 shadow-2xl lg:-right-16 md:-right-4 rounded-2xl 3xl:h-91 3xl:w-96 xl:h-27 lg:w-80 lg:h-85 md:w-72 md:h-27 mt-6" style={{ backgroundColor: backgroundForm }}>
                        ...
                        <div className="mt-6">
                            ...
                            <p className="text-white">Gümüşpala Mh, Manolya Sk, No:2/1A D:1 Avcılar/İstanbul</p>
                        </div>
                        <div className="mt-6">
