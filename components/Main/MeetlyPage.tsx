                ...
                <div className="flex justify-around">
                    <div className={cn(' absolute left-9 lg:block md:hidden hidden -mt-4')}>
                        <div className="absolute flex lg:mt-24 lg:mr-14">
                            ...
                            <img
                                className="h-6 -mt-1"
                                src="/images/Meetly/meetly-search.png"
                                alt=""
                            />
                        </div>
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-12 lg:bottom-2 md:bottom-1 bottom-0 lg:left-12 lg:ml-9 md:left-14 md:ml-2 left-10 ml-3 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                            <div className="z-10 absolute flex lg:mt-5 md:mt-3 mt-5">
                                <div
                                    className={`absolute w-4 h-4 bg-pink-600 transition-all duration-300 delay-1300 ${
                                        animation ? 'opacity-1' : 'opacity-0'
                                    } rounded-full`}
                                ></div>
                                <div
                                    className={`border-dashed border-red-500 border-t-2 transition-all duration-300 delay-1500 ${
                                        animation ? 'lg:w-24 md:w-16 lg:-mr-20 md:-mr-16' : 'w-0'
                                    } mt-2`}
                                ></div>
                                <div
                                    className={`border-dashed border-red-500 border-r-2 transition-all duration-300 delay-1700 ${
                                        animation ? 'lg:h-24 md:h-16' : 'h-0'
                                    } lg:-mr-24 lg:mt-2 md:-mr-16 md:mt-2`}
                                ></div>
                                <div
                                    className={`border-dashed border-red-500 border-b-2  transition-all duration-300 delay-1900 ${
                                        animation ? ' lg:w-20 md:w-16 lg:-mr-20  md:-mr-16' : 'w-0'
                                    } lg:mt-2 md:mt-2`}
                                ></div>
                                <Arrow
                                    fill="red"
                                    className={`h-4 w-4 absolute transform -rotate-90  transition-all duration-300 delay-2000 -mr-44 mt-24 ${
                                        animation ? 'opacity-1' : 'opacity-0'
                                    }`}
                                />
                            </div>
                        ...
                        <div className="z-10 absolute mt-6 mr-3 lg:hidden md:hidden">
                            <div
                                className={`absolute w-3 h-3 bg-pink-600 transition-all duration-300 delay-1300 ${
                                    animation ? 'opacity-1' : 'opacity-0'
                                } rounded-full`}
                            ></div>
                            <div
                        ...
                        <div className="z-10 absolute  left-14 flex  lg:mt-24 md:mt-16 mt-16">
                            <div
                                className={`z-10 lg:w-4 lg:h-4 md:w-4 md:h-4 w-3 h-3 bg-pink-500 transition-all duration-300 delay-700 ${
                                    animation ? 'opacity-1' : 'opacity-0'
                        ...
                        <div className="absolute z-10 lg:mt-1 md:mt-1 mt-24 3xl:mr-72 2xl:mr-44 xl:mr-32 md:mr-16">
                            <Fade delay={3000}>
                                <div className="lg:w-96 md:w-72 w-32">
                                    <img
                                        className=""
                                        src="/images/Meetly/meetly-1.png"
                                        alt="test"
                                    />
                                </div>
                            </Fade>
                    ...
                    >
                        <Fade delay={1500}>
                            <div className=" lg:mt-52 lg:mr-28 md:mr-36 h-20 3xl:mr-16 lg:w-52 mt-36 mr-7">
                                <p className="text-left text-white 3xl:text-lg 3xl:w-52 lg:text-sm md:text-sm text-xs w-32 mr-20">
                                    Kişiler belirledikleri filtreleme seçenekleri ile diğer
                        ...
                        <div className="3xl:mt-28">
                            <div className="lg:mt-28 md:mt-36 mt-68 absolute lg:left-20 md:left-16 xs:left-48 xm:left-48">
                                <div
                                    className={cn(
                                        `lg:mt-60 xl:-ml-10 md:mt-40 mt-7 mr-5 md:w-8 flex`,
                                    )}
                                >
                ...
                <div className="flex justify-around">
                    <div className={cn(' absolute left-9 lg:block md:hidden hidden -mt-4')}>
                        <div className="absolute flex lg:mt-24 lg:mr-14">
                            ...
                            <img
                                className="h-6 -mt-2 mr-1"
                                src="/images/Meetly/meetly-restgele.png"
                                alt=""
                            />
                        </div>
                        <img className="w-52" src="/images/vector.png" alt="" />
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-16 lg:bottom-2 md:bottom-1 bottom-0 lg:left-22 lg:ml-12 md:left-22 md:ml-4 left-16 ml-5 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                                ...
                                <div
                                    className={cn(
                                        `border-dashed border-pink-500 border-r-2 transition-all duration-300 delay-1500 ${
                                            animationTwo ? 'lg:h-16 md:h-10' : 'h-0'
                                        } lg:-mr-32 md:-mr-16`,
                                    )}
                                ></div>
                                <div
                ...
                <div className="flex justify-around">
                    <div className={cn(' absolute left-9 lg:block md:hidden hidden -mt-2')}>
                        <div className="absolute flex lg:mt-24 lg:mr-14">
                            ...
                            <img
                                className="h-6 -mt-2 mr-1"
                                src="/images/Meetly/meetly-chat.png"
                                alt=""
                            />
                        </div>
                        <img className="w-52" src="/images/vector.png" alt="" />
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-28 lg:bottom-2 md:bottom-1 bottom-0 lg:left-22 lg:ml-23 md:left-24 md:ml-10 left-22 ml-6 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                        ...
                        <div>
                            <div className="lg:hidden md:hidden">
                                <div className=" z-10 absolute flex mt-48 mr-2">
                                    <div
                                        className={`w-3 h-3 transition-all duration-300 delay-700 ${
                                            animationThree ? 'opacity-1' : 'opacity-0'
                                        } bg-pink-500 rounded-full`}
                                    ></div>
                                    <div
                                        className={cn(
                                            `absolute border-dashed border-red-500 border-b-2 transition-all duration-300 dela-700 ${
                                    ...
                                    <div
                                        className={cn(
                                            `absolute border-dashed border-red-500 border-r-2 transition-all duration-300 delay-900 ${
                                    ...
                                    <Arrow
                                        fill="red"
                                        className={`w-3 h-3 absolute flex transform rotate-180 transition-all duration-300 delay-1000 ${
                                            animationThree ? 'opacity-1' : 'opacity-0'
                                        } -mr-4.5 -mt-10`}
                                    />
                                </div>
                            ...
                            <div className="mt-2 -mr-2">
                                <div
                                    className={`border-dashed border-white transition-all duration-300 delay-700 ${
                                        animationThree ? 'lg:w-24 md:w-12' : 'w-0'
                        ...
                        <div className="absolute 3xl:mr-60 2xl:mr-52 xl:mr-36 lg:mr-16 mr-2">
                            <Fade delay={3000}>
                                <div className="lg:mt-10 md:-mt-6">
                                    <img
                                        className="3xl:w-80 lg:w-64 md:w-72 w-28"
                                        src="/images/Meetly/meetly-3.png"
                                        alt=""
                                    />
                                </div>
                            </Fade>
                            ...
                            <div className="lg:hidden md:hidden">
                                <div className=" lg:mt-52 lg:mr-36 md:mr-36 h-20 lg:w-52 mt-28 mr-5">
                                    <p className="text-left text-white lg:text-sm md:text-sm text-xs w-32 mr-20">
                                        Kullanıcılar yeni eşleşmelerini burada görür ve onlara mesaj
                                        atabilir.{' '}
                                    </p>
                                </div>
                            </div>
                        ...
                        <Fade delay={1700}>
                            <div className="lg:block md:block hidden">
                                <div className=" lg:mt-48 lg:mr-72 md:mr-40 md:mt-32 h-20 lg:w-52 mt-20">
                                    <p className="text-left text-white 3xl:text-lg  3xl:w-60 lg:text-sm md:text-sm text-xs w-32 mr-20">
                                        Kullanıcılar yeni eşleşmelerini burada görür ve onlara mesaj
                                        atabilir.{' '}
                                    </p>
                                </div>
                ...
                <div className="flex justify-around">
                    <div className={cn(' absolute left-9 lg:block md:hidden hidden -mt-4')}>
                        <div className="absolute flex lg:mt-24 lg:mr-16">
                            ...
                            <img
                                className="h-6 -mt-2 mr-1"
                                src="/images/Meetly/meetly-profile.png"
                                alt=""
                            />
                        </div>
                        <img className="w-52" src="/images/vector.png" alt="" />
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute lg:bottom-2 md:bottom-1 bottom-0 lg:left-8 lg:ml-4 md:left-7 md:ml-2 left-6 ml-1 cursor-pointer`}
                        />
                        <div className="absolute mt-24 lg:block md:block hidden">
                            <div className="z-10 absolute lg:mt-24 lg:mr-5 md:mt-14 md:mr-14 flex">
                                <div
                                    className={`absolute w-4 h-4 bg-pink-500 rounded-full  transition-all duration-300 delay-1300 ${
                                        animationFour ? 'opacity-1' : 'opacity-0'
                                    }`}
                                ></div>
                                <div
                                    className={`absolute border-dashed border-b-2  transition-all duration-300 delay-1300 ${
                                        animationFour
                                            ? 'lg:w-48 md:w-40 lg:-mr-48 md:-mr-40'
                                            : 'opacity-0'
                                    } border-red-500 mt-2`}
                                ></div>
                                <Arrow
                                    fill="red"
                                    className={`w-4 h-4 absolute transform -rotate-90  transition-all duration-300 delay-1500  ${
                                        animationFour ? 'opacity-1' : 'opacity-0'
                                    } lg:-mr-52 lg:mt-0.5 md:-mr-44 md:mt-0.5`}
                                />
                            </div>
                        </div>
                        {/* responsive */}
                        ...
                        <div className="z-10 absolute  left-14 flex mt-16 lg:hidden md:hidden">
                            ...
                            ></div>
                            <div
                                className={`absolute border-dashed border-white border-b-2 transition-all duration-300 dela-700 ${
                                    animationFour ? 'w-24' : 'w-0'
                                } mt-1`}
                            ></div>
                            <div
                                className={`absolute border-dashed border-white border-l-2 transition-all duration-300 delay-900 ${
                                    animationFour ? 'h-8' : 'h-0'
                                } w-24 mt-1`}
                            ></div>
                            <Arrow
                                fill="#fff"
                                className={`w-3 h-3 absolute  transition-all duration-300 delay-1000  ${
                                    animationFour ? 'opacity-1' : 'opacity-0'
                                } mr-21 mt-7`}
                            />
                        </div>
                        ...
                        <div className="z-10 absolute lg:block md:block hidden mr-48">
                            <div className="left-14 flex lg:mt-64 md:mt-52 md:-mr-10">
                                <div
                                    className={`z-10 w-4 h-4 bg-pink-500 transition-all duration-300 delay-700 ${
                                        animationFour ? 'opacity-1' : 'opacity-0'
                                    } rounded-full absolute -mt-1`}
                                ></div>
                                <div
                                    className={`absolute border-dashed border-white border-b-2 transition-all duration-300 delay-700 ${
                                        animationFour ? 'md:w-36 lg:w-40' : 'w-0'
                                    } md:mt-1 lg:mt-1 mt-2`}
                                ></div>
                                <Arrow
                                    fill="white"
                                    className={`lg:w-4 lg:h-4 md:w-4 md:h-4 absolute transition-all duration-300 delay-900 ${
                                        animationFour ? 'opacity-1' : 'opacity-0'
                                    } transform rotate-90 lg:mr-40 md:mr-36 md:-mt-0.5 lg:-mt-0.5`}
                                />
                            </div>
                        </div>
                        {/* card */}
                        ...
                        <div className="absolute 3xl:mr-72 2xl:mr-52 xl:mr-36 lg:mr-16">
                            <Fade delay={3000}>
                                <div className=" lg:mt-52 md:mt-44 h-20 mt-36 -mr-24 ">
                                    <p className="text-left 3xl:text-lg 3xl:w-60 lg:w-60 lg:text-sm md:text-sm text-xs w-32 mr-20">
                                        Kullanıcılar profil sekmesinden kişisel bilgilerini düzenler
                                        ve diğer kullanıcılarla olan etkileşimlerini takip edebilir.{' '}
                                    </p>
                                </div>
                            </Fade>
                        </div>
                    ...
                    >
                        <Fade delay={1500}>
                            <div className=" lg:mt-64 md:mt-44 lg:mr-60 md:mr-48 h-20  mt-36 mr-5">
                                <p className="text-left text-white 3xl:text-lg 3xl:w-60 lg:w-60 lg:text-sm md:text-sm text-xs w-32 mr-20">
                                    Premium üyeliği aktif eden kullanıcılar daha fazla özelliğe
                                    erişebilir.{' '}
                                </p>
                            </div>
                        </Fade>
