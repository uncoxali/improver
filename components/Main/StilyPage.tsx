                ...
                <div className="flex justify-around">
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-9 lg:bottom-3 md:bottom-2 bottom-1 lg:left-12 lg:ml-6 md:left-14 md:ml-0 left-12 cursor-pointer`}
                        />
                                ...
                                <div
                                    className={cn(
                                        `border-dashed border-pink-500 border-b-2 transition-all duration-300 delay-1300 ${
                                            animation
                                                ? 'lg:w-32 lg:-mr-32 md:w-24 md:-mr-24'
                                                : 'w-0'
                                        }`,
                                    )}
                                ></div>
                        ...
                        <div>
                            <div className="lg:hidden md:hidden">
                                <div className=" z-10 absolute flex mt-32 mr-2">
                                    <div
                        ...
                        <div className="z-10 absolute  left-12 flex  lg:mt-10 md:mt-16 mt-7">
                            <div
                                className={`z-10 lg:w-4 md:w-4 lg:h-4 md:h-4 w-3 h-3 bg-pink-500 transition-all duration-300 delay-700 ${
                                    animation ? 'opacity-1' : 'opacity-0'
                ...
                <div className="mt-16 lg:h-96 h-32 flex">
                    <div className=" w-1/2 lg:h-96 md:h-96 h-28">
                        <div className="absolute 2xl:mr-60 xl:mr-40 lg:mr-16 md:mr-10">
                            <Fade delay={3000}>
                                <div className="3xl:mt-52 3xl:mr-44 lg:mt-40 md:mt-28 mt-8 lg:w-44 md:w-36 w-28">
                                    <p className="text-left text-black lg:text-sm md:text-sm text-xs">
                                        İsterse gönderilerini düzenleyebilir, oy verip yorum yapar
                                        veya paylaşır.{' '}
                                    </p>
                                </div>
                            </Fade>
                    ...
                    >
                        <Fade delay={1500}>
                            <div className=" lg:mt-44 lg:mr-32 md:mr-36 h-20 lg:w-52 mt-36 mr-5">
                                <p className="lg:text-xl md:text-xl text-left text-white ">
                                    Kişiler diğer
                                </p>
                                <p className="text-left text-white lg:text-sm md:text-sm text-xs w-32 mr-20">
                                    kullanıcıların paylaştığı kombinleri keşfeder.{' '}
                                </p>
                            </div>
                        </Fade>
                        <div className="3xl:mt-28">
                            <div className="lg:mt-28 md:mt-36 mt-68 absolute lg:left-20 md:left-16 left-48">
                                <div
                                    className={cn(
                                        `3xl:ml-16 xl:ml-14 lg:mt-60  md:mt-40 mt-7 mr-8 md:w-8 flex`,
                                    )}
                                >
                ...
                <div className="flex justify-around">
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-17 lg:bottom-6 md:bottom-4 bottom-2 lg:left-14 lg:ml-14 md:left-12 md:ml-10 left-12 ml-6 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                            <div className="z-10 absolute flex lg:mt-40 md:mt-28 lg:mr-10 md:mr-5">
                                ...
                                <div
                                    className={cn(
                                        `border-dashed border-pink-500 border-b-2 transition-all duration-300 delay-1500 ${
                                            animationTwo
                                                ? 'lg:w-60 lg:-mr-60 md:w-32 md:-mr-32'
                                                : 'w-0'
                                        }`,
                                    )}
                                ></div>
                                <Arrow
                                    fill="red"
                                    className={`h-4 w-4 absolute transform -rotate-90 transition-all duration-300 delay-1700 -mr-2 mt-9 ${
                                        animationTwo ? 'opacity-1' : 'opacity-0'
                                    } -mt-2 lg:block md:hidden lg:-mr-64`}
                                />
                            </div>
                        </div>
                        ...
                        <div className="z-10 absolute lg:bottom-32 bottom-16 left-14 flex  lg:mt-10 md:mt-16 mt-16">
                            ...
                            <div
                                className={`absolute border-dashed border-white border-l-2 transition-all duration-300 delay-900 ${
                                    animationTwo ? 'lg:h-22 md:h-7 h-8 lg:-mt-20 -mt-7' : 'h-0'
                                } md:w-52 w-24 mt-2`}
                            ></div>
                            <Arrow
                                fill="#fff"
                                className={`lg:h-4 lg:w-4 md:w-4 md:h-4 w-3 h-3 transform rotate-180 absolute  transition-all duration-300 delay-1000  ${
                                    animationTwo ? 'opacity-1' : 'opacity-0'
                                } md:mr-15 md:mt-7 lg:-mt-22 mr-21 -mt-8`}
                            />
                        </div>
                    ...
                    <div className=" w-1/2 lg:h-96 md:h-96 h-28">
                        <div className="z-10 absolute 2xl:mr-52 xl:mr-28 md:mr-16">
                            <Fade delay={2200}>
                                <div className="mt-14">
                                    <img
                                        className="lg:w-80 md:w-72 md:-mt-5 w-32"
                                        src="/images/Stily/stily-2.png"
                                        alt=""
                                    />
                                </div>
                            </Fade>
                        ...
                        <Fade delay={1500}>
                            <div className="3xl:mr-10 lg:mt-24 lg:mr-14 md:mr-36 h-20 lg:w-52 mt-14 mr-5">
                                <p className="text-left text-white 3xl:text-lg 3xl:w-60 lg:w-52 lg:text-sm md:text-sm text-xs w-32 mr-20">
                                    Daha önceden butona basmış kişiler sıraya alınır ve diğer
                                    kullanıcılar ile karşılaşır. Kişi beğendiği kullanıcıyı seçerek
                                    %100 eşleşme gerçekleştirebilir
                                </p>
                            </div>
                        </Fade>
                        <div className="3xl:mt-28">
                ...
                <div className="flex justify-around">
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute 3xl:ml-25 lg:bottom-3 md:bottom-2 bottom-0 lg:left-16 lg:ml-22 md:left-12 md:ml-16 left-14 ml-9 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                                ...
                                <div
                                    className={cn(
                                        `border-dashed border-pink-500 border-r-2 transition-all duration-300 delay-1500 ${
                                            animationThree ? 'lg:h-10 md:h-28' : 'h-0'
                                        } lg:-mr-28 md:-mr-20`,
                                    )}
                                ></div>
                                <div
                        ...
                        <div>
                            <div className="lg:hidden md:hidden">
                                <div className=" z-10 absolute flex mt-40 mr-2">
                                    <div
                                        className={`w-3 h-3 transition-all duration-300 delay-300 ${
                                            animationThree ? 'opacity-1' : 'opacity-0'
                                        } bg-pink-500 rounded-full`}
                                    ></div>
                                    <div
                                        className={cn(
                                            `absolute border-dashed border-red-500 border-b-2 transition-all duration-300 ${
                                    ...
                                    <div
                                        className={cn(
                                            `absolute border-dashed border-red-500 border-r-2 transition-all duration-300 delay-300 ${
                                    ...
                                    <Arrow
                                        fill="red"
                                        className={`w-3 h-3 absolute flex transform rotate-180 transition-all duration-300 delay-500 ${
                                            animationThree ? 'opacity-1' : 'opacity-0'
                                        } -mr-4.5 -mt-10`}
                                    />
                                </div>
                        ...
                        <div className="lg:hidden md:hidden ">
                            ...
                            >
                                <div className="absolute mr-2">
                                    <div
                                        className={cn(
                                            `border-dashed border-white transition-all duration-300 ${
                                    ...
                                    <div
                                        className={cn(
                                            `border-dashed border-white border-l-2 transition-all duration-300 delay-300 ${
                        ...
                        <Fade delay={3000}>
                            <div className="flex">
                                <div className="right-0 md:mt-10">
                                    <img
                                        className="lg:w-52 md:w-32 w-24"
                                        src="/images/Stily/stily-3.png"
                                        alt=""
                                    />
                                </div>
                        ...
                        <Fade delay={1700}>
                            <div className="lg:hidden md:hidden">
                                <div className=" lg:mt-52 lg:mr-36 md:mr-36 h-20 lg:w-52 mt-28 mr-5">
                                    ...
                                    <p className="text-left text-white lg:text-sm md:text-sm text-xs w-32 mr-20">
                                        {' '}
                                        tasarımlarını oluşturur ve yeni kombinler yapabilir.{' '}
                                    </p>
                                </div>
                            </div>
                        </Fade>
                        ...
                        <div>
                            <div className="lg:hidden md:hidden">
                                <div className=" z-10 absolute flex mt-48 mr-2">
                                    <div
                                        className={`w-3 h-3  transition-all duration-1300 ${
                                            animationFour ? 'opacity-1' : 'opacity-0'
                                        } bg-pink-500 rounded-full`}
                                    ></div>
                                    <div
                            ...
                            <Fade delay={3000}>
                                <div className=" text-left text-black 3xl:mr-52 lg:w-80 lg:mt-20 md:mt-16 md:w-48 mt-20">
                                    <div className="lg:block md:block hidden">
                                        <div className="flex">
                                            <img
                                                className="z-10 lg:w-72 md:w-48 w-28"
                                                src="/images/Stily/stily-4.png"
                                                alt=""
                                            />
                                            <img
                                                className="lg:w-20 lg:h-24 rounded-xl transform -rotate-12 md:w-14 md:h-14 md:mt-5 md:-mr-10 w-28 lg:mt-10 lg:-mr-16"
                                                src="/images/Stily/stily-4-2.png"
                                                alt=""
                                            />
                                        </div>
                                    </div>
                                    <div className="lg:w-60 md:w-44 xs:mr-3 -mr-10 w-28 lg:block md:block">
                                        <p className="lg:text-lg md:text-sm text-xs">
                                            Kişiler yaptığı paylaşımlara atılan yorum, puan vb.
                                            aktiviteleri inceleyebilir.{' '}
                                        </p>
                                    </div>
                                </div>
                            </Fade>
                ...
                <div className="flex justify-around">
                    ...
                    <div className="absolute mt-24">
                        <Circle1
                            ...
                            } absolute lg:bottom-3 md:bottom-2 bottom-0 lg:left-1 lg:ml-8 md:left-4 md:ml-3 left-5 cursor-pointer`}
                        />
                        <div className="lg:block md:block hidden">
                            <div className="z-10 absolute flex lg:bottom-36 md:bottom-20 lg:mr-6 md:mr-5">
                                ...
                                <div
                                    className={cn(
                                        `border-dashed border-pink-500 border-r-2 transition-all duration-300 delay-1500 ${
                                            animationFive ? 'lg:h-28 md:h-20' : 'h-0'
                                        } lg:-mr-28 md:-mr-20`,
                                    )}
                                ></div>
                                <div
                        ...
                        <div
                            className={`z-10 absolute transition-all duration-300 delay-200 ${
                                animationFive ? 'opacity-1' : 'opacity-0'
                            } lg:w-4 md:w-4 md:h-4 lg:h-4 lg:block md:block hidden bg-pink-600 h-2 w-2 rounded-full lg:mt-44 md:mt-44 mt-16 left-8 lg:left-10`}
                        >
                            <div className="mt-2 -mr-2">
                                <div
                                    className={`border-dashed border-white transition-all duration-300 delay-700 ${
                        ...
                        <div className="absolute 2xl:mr-60 xl:mr-44 lg:mr-28 md:mr-16">
                            <Fade delay={3000}>
                                <div className="3xl:mr-40">
                                    <img
                                        className="lg:w-52 md:w-48 w-28 -mt-5"
                                        src="/images/Stily/stily-5.png"
                                        alt=""
                                    />
                                </div>
                            </Fade>
                        ...
                        <Fade delay={1700}>
                            <div className="lg:block md:block hidden">
                                <div className=" lg:mt-40 lg:mr-72 md:mr-40 md:mt-32 h-20 lg:w-52 mt-20">
                                    <img
                                        className="lg:w-40 md:w-36 md:mr-5 lg:mr-5"
                                        src="/images/Stily/stily-5-2.png"
                                        alt=""
                                    />
                                </div>
                            </div>
